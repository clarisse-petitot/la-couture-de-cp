        ...
        ?>
            <a href="<?= $page ?>?id_page=1<?= getQueryWithoutIdPage() ?>">
                <li><button class="flex items-center justify-center w-10 h-10 text-pink-500 transition-colors duration-150 rounded-full focus:shadow-outline hover:bg-pink-100">
                        <svg  class="w-2 h-2 fill-current" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120.64 122.88" style="enable-background:new 0 0 120.64 122.88" xml:space="preserve">
                            <g>
