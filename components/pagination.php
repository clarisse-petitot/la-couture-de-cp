...
<nav aria-label="Pagination" class="flex justify-center content-center">
    <ul class="inline-flex space-x-2 pb-24">
        ...
        <a href="creations.php?id_page=1<?= getQueryWithoutIdPage() ?>">
        ...
        if ($id_page != 1) {
        ?>
            <a href="creations.php?id_page=<?= ($id_page - 1) . getQueryWithoutIdPage() ?>">
        ...
        ?>
        <a href="creations.php?id_page=<?= ($id_page) . getQueryWithoutIdPage() ?>">
        ...
        ?>
        <a href="creations.php?id_page=<?= ($nbr_page_total) . getQueryWithoutIdPage() ?>">
            <li><button class="flex items-center justify-center w-10 h-10 text-pink-500 transition-colors duration-150 bg-white rounded-full focus:shadow-outline hover:bg-pink-100">
                    <svg class="w-4 h-4 fill-current" viewBox="0 0 20 20">
